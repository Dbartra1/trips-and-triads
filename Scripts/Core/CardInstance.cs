...
namespace TripsAndTriads.Core
{
	public class CardInstance
	{
		...
		public int         OwnerId         { get; set; }  // current controller (flips on capture)
		public int         OriginalOwnerId { get; }       // who dealt this card — never changes
		...
		public CardInstance(CardData data, int ownerId)
		{
			Data            = data;
			OwnerId         = ownerId;
			OriginalOwnerId = ownerId; // locked at creation, never changes
		}
